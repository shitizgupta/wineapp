...
const lvl1 = "https://community.dynamics.com/cfs-filesystemfile/__key/gamificationcfs/BadgeAvatars/Level-1.png"
                    ...
                    <ScrollView
                        ...
                        <View style={{ alignItems: 'center', paddingBottom: 10 }}>
                            <TouchableOpacity onPress={this._pickImage} style={{ alignItems: 'center' }}>
                                ...
                                <Text style={[styles.placeholder, { paddingVertical: 5 }]}>CLICK TO UPDATE</Text>
                                <Image source={{ uri: lvl1 }} style={{ height: 45, width: 45 }} />
                            </TouchableOpacity>
                        ...
                        <View style={styles.entry}>
                            ...
                            <TextInput placeholder="Jonny Sins Tv"
                        ...
                        <View style={styles.entry}>
                            ...
                            <TextInput keyboardType={'numeric'} placeholder="731656124"
                                style={{ marginTop: 5, opacity: 0.5, width: '80%', height: 20, color: '#fff', fontSize: Theme.large }} />
                        </View>

                        {/* entry */}
                        <View style={styles.entry}>
                            <Text style={styles.placeholder}>Minimum Cost</Text>
                            <TextInput keyboardType={'numeric'} placeholder="Eg : 100000KRW"
                                style={{ marginTop: 5, opacity: 0.5, width: '80%', height: 20, color: '#fff', fontSize: Theme.large }} />
                        </View>
                        ...
                        {/* entry */}
                        <View style={styles.entry}>
                            <Text style={styles.placeholder}>Business Licence</Text>
                            <TextInput placeholder="Premium"
                                style={{ marginTop: 5, opacity: 0.5, width: '80%', height: 20, color: '#fff', fontSize: Theme.large }} />
                        </View>
